...
from jet.audio.speech.transcribe_interview_speechrec import Transcriber
...
class TestTranscriber:
    """Test suite for the Transcriber class using SpeechRecognition."""
    ...
    def test_transcribe_audio_success(self, transcriber):
        ...
        result = transcriber.transcribe_audio(audio, api="google")
