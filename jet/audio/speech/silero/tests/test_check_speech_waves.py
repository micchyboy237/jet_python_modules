...
class TestCheckSpeechWaves:
        ...
        expected: List[SpeechWave] = [
            SpeechWave(
                ...
                details={
                    ...
                    "frame_end": 80,
                    "frame_len": 50,
                    "duration_sec": pytest.approx(1.60, abs=0.01),
    ...
    def test_multiple_complete_waves(self):
        ...
        expected[0]["details"] = {
            ...
            "frame_end": 60,
            "frame_len": 40,
            "duration_sec": pytest.approx(1.28, abs=0.01),
        ...
        expected[1]["details"] = {
            ...
            "frame_end": 150,
            "frame_len": 60,
            "duration_sec": pytest.approx(1.92, abs=0.01),
        ...
        expected: List[SpeechWave] = [
            SpeechWave(
                ...
                details={
                    ...
                    "frame_end": 85,
                    "frame_len": 70,
                    "duration_sec": pytest.approx(2.24, abs=0.01),
        ...
        expected: List[SpeechWave] = [
            SpeechWave(
                ...
                details={
                    ...
                    "frame_end": 21,
                    "frame_len": 1,
                    "duration_sec": pytest.approx(0.032, abs=0.01),
                    "min_prob": pytest.approx(0.85, abs=1e-6),
                    "max_prob": pytest.approx(0.85, abs=1e-6),
                    "mean_prob": pytest.approx(0.85, abs=1e-6),
                    "std_prob": pytest.approx(0.0, abs=1e-6),
        ...
        expected: List[SpeechWave] = [
            SpeechWave(
                ...
                details={
                    ...
                    "frame_end": 40,
                    "frame_len": 30,
                    "duration_sec": pytest.approx(0.96, abs=0.01),
                    "min_prob": pytest.approx(0.9, abs=1e-6),
                    "max_prob": pytest.approx(0.9, abs=1e-6),
                    "mean_prob": pytest.approx(0.9, abs=1e-6),
                    "std_prob": pytest.approx(0.0, abs=1e-6),
        ...
        expected: List[SpeechWave] = [
            SpeechWave(
                ...
                details={
                    ...
                    "frame_end": 312,
                    "frame_len": 212,
                    "duration_sec": pytest.approx(6.78, abs=0.01),
                    "min_prob": pytest.approx(0.95, abs=1e-6),
                    "max_prob": pytest.approx(0.95, abs=1e-6),
                    "mean_prob": pytest.approx(0.95, abs=1e-6),
                    "std_prob": pytest.approx(0.0, abs=1e-6),
        ...
        expected: List[SpeechWave] = [
            SpeechWave(
                ...
                details={
                    ...
                    "frame_end": 150,
                    "frame_len": 150,
                    "duration_sec": pytest.approx(4.8, abs=0.01),
                    "min_prob": pytest.approx(0.9, abs=1e-6),
                    "max_prob": pytest.approx(0.9, abs=1e-6),
                    "mean_prob": pytest.approx(0.9, abs=1e-6),
                    "std_prob": pytest.approx(0.0, abs=1e-6),
        ...
        expected: List[SpeechWave] = [
            SpeechWave(
                ...
                details={
                    ...
                    "frame_end": 14,
                    "frame_len": 4,
                    "duration_sec": pytest.approx(0.128, abs=0.01),
