...
from jet.adapters.stanza import dependency_visualization as viz


def conll_to_visual(conll_file, pipeline, sent_count=10, display_all=False) -> List[str]:
    """
    ...
    if display_all:
        return viz.visualize_doc(conll.CoNLL.conll2doc(conll_file), pipeline)
