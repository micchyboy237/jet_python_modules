...
def visualize_ner_doc(doc, language, select=None, colors=None) -> List[str]:
    ...
    for document in documents:
        html = displacy.render(document, style='ent', options=visualization_options)
        html_strings.append(html)
    return html_strings


def visualize_ner_str(text, pipe, select=None, colors=None) -> List[str]:
    """
    ...
    """
    doc = pipe(text)
    return visualize_ner_doc(doc, pipe.lang, select, colors)


def visualize_strings(texts, language_code, select=None, colors=None) -> List[List[str]]:
    """
...
def visualize_docs(docs, language_code, select=None, colors=None) -> List[List[str]]:
    """
