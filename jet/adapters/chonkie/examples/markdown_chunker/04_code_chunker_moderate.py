"""Example: CodeChunker with moderate chunk size (600 tokens)."""
...
def main() -> None:
    console.rule("[bold]Example 04 – CodeChunker (chunk_size=600)[/bold]")
    ...
    output_dir = Path(__file__).parent.parent / "generated" / "04_code_chunker_moderate"
