        ...
        **kwargs,
        ...
        try:
            ...
            completion_params = {
                "model": self.model_name,
                "messages": messages,
                "stream": True if self.model_name.startswith("ollama/") else self.stream,
            ...
            if self.model_name.startswith("ollama/"):
                logger.gray("LiteLLM Settings for Ollama:")
                ...
                elif self.reasoning_enabled and self.reasoning_effort is not None:
