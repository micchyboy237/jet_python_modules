...
LLAMACPP_LLM_MODELS: dict[LLAMACPP_LLM_KEYS, LLAMACPP_LLM_VALUES] = {
    ...
    "Ministral-3B-Instruct": "mistralai/Ministral-3-3B-Instruct-2512",
}
...
LLAMACPP_MODEL_CONTEXTS: dict[LLAMACPP_KEYS, int] = {
    ...
    "Ministral-3B-Instruct": 262144,  # https://huggingface.co/mistralai/Ministral-3-3B-Instruct-2512
}
