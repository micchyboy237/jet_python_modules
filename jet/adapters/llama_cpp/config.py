...
EMBED_MODEL_LG = os.getenv("LLAMA_CPP_EMBED_LG_MODEL", DEFAULT_EMBED_LG_MODEL)
EMBED_BASE_HOST_LG = os.getenv("LLAMA_CPP_EMBED_LG_HOST")
EMBED_BASE_URL_LG = os.getenv("LLAMA_CPP_EMBED_LG_URL")
EMBED_DIMS_LG = int(os.getenv("LLAMA_CPP_EMBED_LG_DIMS", "768"))
EMBED_QUERY_PREFIX_LG = os.getenv("EMBED_LG_QUERY_PREFIX", "")
EMBED_DOC_PREFIX_LG = os.getenv("EMBED_LG_DOC_PREFIX", "")
