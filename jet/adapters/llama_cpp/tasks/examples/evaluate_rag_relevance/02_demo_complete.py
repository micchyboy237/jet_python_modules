...
# Long context that FULLY answers the query — demonstrates complete RAG evaluation
LONG_CONTEXT = """
...
• SmartHome: Revenue $381M (45% of total), Net Income $35.2M, EPS $0.64, YoY Revenue Growth +8%
• WearableTech: Revenue $127M (15% of total), Net Income $18.7M, EPS $0.34, YoY Revenue Growth +28%
• EcoKitchen: Revenue $339M (40% of total), Net Income $24.4M, EPS $0.44, YoY Revenue Growth -3%
...
console.print(
    "\n[bold green]RAG Relevance Evaluation — Complete Context Test[/bold green]"
)
