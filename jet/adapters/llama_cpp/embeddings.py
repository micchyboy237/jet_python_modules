...
class LlamacppEmbedding:
    ...
    def __init__(
        ...
        max_retries: int = 3,
        cache_backend: Literal["memory", "file", "sqlite"] = "memory",
    ...
    def get_embedding_function(
        ...
        """Return callable with caching."""
        def embedding_function(inputs: Union[str, List[str]]) -> GenerateEmbeddingsReturnType:
            return self.get_embeddings(
                inputs, return_format=return_format, batch_size=batch_size,
                show_progress=show_progress, use_cache=use_cache
            )
