...
class LlamacppEmbedding:
    ...
    def __init__(self, model: str = "embeddinggemma", base_url: str = "http://shawn-pc.local:8081/v1", timeout: float = 30.0, max_retries: int = 3):
        """Initialize the client with server URL, model path, timeout, and max retries."""
        self.client = OpenAI(base_url=base_url, api_key="no-key-required", timeout=timeout, max_retries=max_retries)
