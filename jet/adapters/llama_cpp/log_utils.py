...
def print_request_panel(messages: list, params: Dict[str, Any]) -> None:
    ...
    console.print(
        Panel(body, title="[bold blue]⟶ LLM Request[/bold blue]", expand=False)
    )


def print_response_panel(
    content: str, reasoning: Optional[str], usage: Optional[Dict]
) -> None:
    ...
    console.print(
        Panel(body, title="[bold green]⟵ LLM Response[/bold green]", expand=False)
    )


def print_stream_end_panel(
    content: str, reasoning: Optional[str], elapsed: float
) -> None:
    ...
    console.print(
        Panel(body, title="[bold green]⟵ Stream complete[/bold green]", expand=False)
    )
