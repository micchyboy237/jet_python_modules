...
class LoggerOverlay(QMainWindow):
    ...
    def log(self, level: LogLevel, message: str, render_mode: str = "text") -> None:
        payload = json.dumps(
            {
                "level": level,
                "message": message,
...
class Logger:
    ...
    def html(self, html_string: str, level: LogLevel = "info") -> None:
        self._overlay.log(level, html_string, render_mode="html")
