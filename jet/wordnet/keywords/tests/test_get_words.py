...
class TestGetWords:
    ...
    def test_given_text_with_slash_or_pipe_when_getting_words_then_splits_on_special_chars(self, setup_nltk):
        # Given
        input_text = "input/output yes|no. This is true|false."
        expected_n1 = ["input", "output", "yes",
                       "no", "This", "is", "true", "false"]
        expected_n2 = ["input output", "output yes", "yes no",
                       "This is", "is true", "true false"]
        input_list = ["input/output yes|no.", "true|false test."]
        expected_list_n1 = [
            ["input", "output", "yes", "no"],
            ["true", "false", "test"]
        ]
