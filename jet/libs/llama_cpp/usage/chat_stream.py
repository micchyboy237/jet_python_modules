...
def run_chat_stream(
    ...
    *,
    ...
    system_prompt_addition_override: str | None = None,
    ...
    if system_prompt_addition_override is not None:
        resolved_fmt.system_prompt_addition = system_prompt_addition_override
