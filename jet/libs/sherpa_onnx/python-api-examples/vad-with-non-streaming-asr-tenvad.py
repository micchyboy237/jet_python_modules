...
with VAD (using ten-vad.onnx) and non-streaming ASR models for speech recognition
from a microphone.
...
python /Users/jethroestrada/Desktop/External_Projects/Jet_Projects/jet_python_modules/jet/libs/sherpa_onnx/vad-with-non-streaming-asr-tenvad.py \
...
def main():
    ...
    # Configure for ten-vad rather than silero-vad
    config = sherpa_onnx.VadModelConfig()
    config.ten_vad.model = args.ten_vad_model
    config.ten_vad.min_silence_duration = 0.25
