...
class OpenAIInterface(ModelInterface):
    ...
    def __init__(self, model_name: str, api_key: Optional[str] = None):
        ...
        """
        self.client = LlamacppLLM(model=model_name, verbose=True)
    
    def generate(self, context: str, max_tokens: Optional[int] = None) -> str:
...
class ControlLoop:
    ...
    def __init__(self, 
        ...
        """
        self.model = LlamacppLLM(model=model, verbose=True)
