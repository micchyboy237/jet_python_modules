...
from jet.adapters.browser_use.ollama.chat import ChatOllama, Controller
...
class GmailGrantManager:
    ...
    def __init__(self):
        ...
        print(
            f'GmailGrantManager initialized with config_dir: {self.config_dir}')
        print(
            f'GmailGrantManager initialized with credentials_file: {self.credentials_file}')
        print(
            f'GmailGrantManager initialized with token_file: {self.token_file}')
        ...
        while True:
            ...
            if user_input == 'skip':
                ...
                if self.check_credentials_exist():
                    ...
                    print(
                        f'❌ Credentials file still not found at: {self.credentials_file}')
            elif user_input == 'n':
...
async def main():
    ...
    agent = Agent(task='Get recent emails from Gmail to test the integration is working properly',
