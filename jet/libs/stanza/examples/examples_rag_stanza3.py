...
from jet.libs.stanza.rag_stanza3 import build_stanza_pipeline, parse_sentences, chunk_sentences_for_rag, build_context_chunks, transformer_token_counter
...
def example_full_pipeline():
    ...
    chunks = chunk_sentences_for_rag(sentences, max_tokens=60, overlap=15, token_counter=token_counter)
...
def example_quick_pipeline():
    ...
    token_counter = transformer_token_counter(model_name="bert-base-uncased")
    chunks = build_context_chunks(LONG_TEXT, lang="en", max_tokens=80, overlap=20, token_counter=token_counter)
