...
out = batched_grid_agent_execution(
    agents=[agent, agent],
    tasks=[
        "Scrape https://anilist.co website, navigate through relevant pages and provide a full report of the latest and upcoming isekai and romantic comedy anime. The format type should be full.",
