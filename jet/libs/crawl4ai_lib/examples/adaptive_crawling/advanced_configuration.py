...
async def main():
    ...
    high_precision_config = get_adaptive_config(
    ...
    balanced_config = get_adaptive_config(
    ...
    quick_config = get_adaptive_config(
    ...
    persistent_config = get_adaptive_config(
    ...
    async with AsyncWebCrawler(verbose=False) as crawler:
        ...
        interrupt_config = get_adaptive_config(
            confidence_threshold=0.8,
        ...
        resume_config = get_adaptive_config(
            confidence_threshold=0.8,
    ...
    conservative_config = get_adaptive_config(
    ...
    aggressive_config = get_adaptive_config(
        confidence_threshold=0.7,
        max_pages=15,
    ...
    async with AsyncWebCrawler(verbose=False) as crawler:
        for strategy_name, config in [
            ...
            print(f"  - Unique domains: {len(set(urlparse(url).netloc for url in result.crawled_urls if urlparse(url).netloc))}")
    ...
    monitor_config = get_adaptive_config(
