...
def example():
    tool_names = ["browser_navigate", "browser_take_screenshot"]

    messages = [ChatMessage.from_user("""
    Navigate to https://www.nbcnews.com and capture a screenshot of the body element and save to full_page.png
    """)]
