...
def create_system_prompt(labels: List[str]) -> str:
    """Creates a formatted system prompt with the given classification labels."""
    return f"Classify the following text by choosing one of the options provided without any additional text.\nOptions:\n{'\n'.join(labels)}"
...
def text_classification(
    ...
    """Performs text classification on the input text."""
    try:
