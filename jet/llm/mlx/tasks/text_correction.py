...
def create_system_prompt() -> str:
    ...
    return (
        "You are a grammar and style expert. Correct the given input text for grammar, spelling, punctuation, "
...
def text_correction(
    ...
    """
    Corrects the input text for grammar, spelling, punctuation, and clarity issues.
    ...
    Returns:
        CorrectionResult: Dictionary containing the corrected text and metadata.
    """
    try:
