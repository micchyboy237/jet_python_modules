...
class TestExtractHeaderHierarchy:
    def test_single_header_with_content(self):
        # Given: HTML with one h1 header and a paragraph
        html = """
        <h1>Main Header</h1>
        ...
        # Then: Expect one section with header, content, HTML, and tag
    ...
    def test_nested_headers(self):
        # Given: HTML with nested h1 and h2 headers
        html = """
        <h1>Main Header</h1>
        <p>Main content.</p>
        ...
        # Then: Expect two sections with correct hierarchy, HTML, and tags
        expected: List[HeaderDoc] = [
            {
                "id": result[0]["id"],
                "doc_index": 0,
    ...
    def test_content_before_header(self):
        # Given: HTML with content before any header
        html = """
        <p>Intro content.</p>
        <h1>Main Header</h1>
        <p>Main content.</p>
        ...
        # Then: Expect two sections, one for intro content with empty HTML and tag
        expected: List[HeaderDoc] = [
            {
                "id": result[0]["id"],
                "doc_index": 0,
    ...
    def test_excluded_elements(self):
        # Given: HTML with excluded elements like script
        html = """
        <h1>Main Header</h1>
        <p>Main content.</p>
        ...
        # When: Extracting header hierarchy with default excludes
        result: List[HeaderDoc] = extract_header_hierarchy(html)

        # Then: Expect one section, ignoring script and footer
        expected: List[HeaderDoc] = [{
            "id": result[0]["id"],
            "doc_index": 0,
            "header": "Main Header",
