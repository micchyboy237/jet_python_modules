...
class TestChunkHeadersByHierarchy:
    def test_chunk_headers_by_hierarchy_with_root(self, chunking_shared, markdown_text):
        ...
        expected = [
            {
                ...
                "level": 1,
                "parent_level": None,
                "metadata": {"start_idx": 15, "end_idx": 41},
            },
            {
                ...
                "level": 2,
                "parent_level": 1,
                "metadata": {"start_idx": 62, "end_idx": 110},
            },
            {
                ...
                "level": 2,
                "parent_level": 1,
                "metadata": {"start_idx": 112, "end_idx": 161},
            },
            {
                ...
                "level": 3,
                "parent_level": 2,
                "metadata": {"start_idx": 183, "end_idx": 212},
            },
            {
                ...
                "level": 3,
                "parent_level": 2,
                "metadata": {"start_idx": 214, "end_idx": 245},
            },
            {
                ...
                "level": 3,
                "parent_level": 2,
                "metadata": {"start_idx": 247, "end_idx": 276},
            },
        ]
        ...
        for res, exp in zip(results, expected):
            ...
            assert isinstance(res["header_doc_id"], str) and res["header_doc_id"]
            assert isinstance(res.get("parent_id", None), (str, type(None)))
            res_no_ids = {
                k: v
                for k, v in res.items()
                if k not in ["id", "header_doc_id", "parent_id"]
            }
            exp_no_ids = {
                k: v
        ...
        expected = [
            {
                ...
                "level": 2,
                "parent_level": None,
                "metadata": {"start_idx": 19, "end_idx": 67},
            },
            {
                ...
                "level": 2,
                "parent_level": None,
                "metadata": {"start_idx": 69, "end_idx": 118},
            },
            {
                ...
                "level": 3,
                "parent_level": 2,
                "metadata": {"start_idx": 140, "end_idx": 169},
            },
            {
            ...
            },
            {
                ...
                "level": 3,
                "parent_level": 2,
                "metadata": {"start_idx": 204, "end_idx": 233},
            },
        ]
        results = chunk_headers_by_hierarchy(
            markdown_text, chunk_size, tokenizer, split_fn
...
class TestChunkDocsByHierarchy:
    def test_chunk_docs_by_hierarchy_multiple_docs(
        self, chunking_shared, markdown_text
    ):
...
"""
        ...
        expected = [
            ...
            },
            {
                ...
                "level": 2,
                "parent_level": None,
                "metadata": {"start_idx": 19, "end_idx": 77},
            ...
            },
            {
                ...
                "level": 3,
                "parent_level": 2,
                "metadata": {"start_idx": 95, "end_idx": 151},
                "doc_id": "f1f3bb98-1912-4aeb-8ae1-04495421dc59",
            },
        ]
        ...
        assert len(results) == len(expected), (
            f"Expected {len(expected)} chunks, got {len(results)}"
        )
        for res, exp in zip(results, expected):  # Fixed invalid loop variable
            ...
            assert isinstance(res["header_doc_id"], str) and res["header_doc_id"], (
                "Header doc ID must be a non-empty string"
            )
            assert isinstance(res.get("parent_id", None), (str, type(None))), (
                "Parent ID must be a string or None"
            )
            assert isinstance(res["doc_id"], str) and res["doc_id"], (
                "Doc ID must be a non-empty string"
            )
            res_no_ids = {
                k: v
                for k, v in res.items()
                if k not in ["id", "header_doc_id", "parent_id", "doc_id"]
            }
            exp_no_ids = {
                k: v
                for k, v in exp.items()
            ...
            assert res_no_ids == exp_no_ids, (
                f"Chunk mismatch: {res_no_ids} != {exp_no_ids}"
            )
