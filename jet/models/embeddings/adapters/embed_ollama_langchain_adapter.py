...
class OllamaEmbeddingsLangchainAdapter(BaseModel, Embeddings):
    ...
    model: EmbedModelType = "mxbai-embed-large"
    """Model name to use."""
    ...
    def embed_documents(self, texts: List[str]) -> List[List[float]]:
        ...
        """
        instruction_pairs = [
            f"{self.embed_instruction}{text}" for text in texts]
        embeddings = generate_embeddings(
            instruction_pairs, self.model, show_progress=self.show_progress, return_format="list")
        return embeddings
    ...
    def embed_query(self, text: str) -> List[float]:
        ...
        embedding = generate_embeddings(
            [instruction_pair], self.model, show_progress=self.show_progress, return_format="list")[0]
        return embedding
