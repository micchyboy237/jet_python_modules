  ...
  - source_sentence: jak wysłać sf do krs?
    sentences:
      ...
      - Lie (L) – The Lie scale is intended to identify individuals who are deliberately
        ...
        people.
  - source_sentence:
      "Air Pollution in Eastern Asia: An Integrated Perspective: Chapter
  ...
  - source_sentence: What type of stimuli do nociceptors response to?
    sentences:
      ...
      - The first attempt to establish a proper governing body and adopted the current
        ...
        become The CFL.
  - source_sentence:
      "Gadofosveset-enhanced MR angiography of carotid arteries: does
...
model = SentenceTransformer("sentence-transformers/static-retrieval-mrl-en-v1", truncate_dim=256)
...
- Loss: [<code>MatryoshkaLoss</code>](https://sbert.net/docs/package_reference/sentence_transformer/losses.html#matryoshkaloss) with these parameters:
  ```json
  {
    ...
    "matryoshka_weights": [1, 1, 1, 1, 1, 1],
    "n_dims_per_step": -1
  }
  ```
